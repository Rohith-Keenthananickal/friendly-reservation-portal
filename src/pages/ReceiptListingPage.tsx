...
const mockReservations: Reservation[] = [
  { id: '1', reservationNumber: 'RES-2025-001', guestName: 'John Doe', totalAmount: 15000, advanceAmount: 5000, balanceAmount: 10000, pendingAmount: 10000, settlementStatus: 'PENDING', checkInDate: '2025-12-01', checkOutDate: '2025-12-05' },
  { id: '2', reservationNumber: 'RES-2025-002', guestName: 'Jane Smith', totalAmount: 25000, advanceAmount: 25000, balanceAmount: 0, pendingAmount: 0, settlementStatus: 'SETTLED', checkInDate: '2025-12-02', checkOutDate: '2025-12-06' },
  { id: '3', reservationNumber: 'RES-2025-003', guestName: 'Robert Wilson', totalAmount: 18000, advanceAmount: 10000, balanceAmount: 8000, pendingAmount: 8000, settlementStatus: 'PARTIALLY_SETTLED', checkInDate: '2025-12-03', checkOutDate: '2025-12-07' },
  { id: '4', reservationNumber: 'RES-2025-004', guestName: 'Emily Brown', totalAmount: 32000, advanceAmount: 0, balanceAmount: 32000, pendingAmount: 32000, settlementStatus: 'PENDING', checkInDate: '2025-12-04', checkOutDate: '2025-12-08' },
  { id: '5', reservationNumber: 'RES-2025-005', guestName: 'Michael Johnson', totalAmount: 20000, advanceAmount: 12000, balanceAmount: 8000, pendingAmount: 8000, settlementStatus: 'PARTIALLY_SETTLED', checkInDate: '2025-12-05', checkOutDate: '2025-12-09' },
  { id: '6', reservationNumber: 'RES-2025-006', guestName: 'Sarah Davis', totalAmount: 28000, advanceAmount: 28000, balanceAmount: 0, pendingAmount: 0, settlementStatus: 'SETTLED', checkInDate: '2025-12-06', checkOutDate: '2025-12-10' },
  { id: '7', reservationNumber: 'RES-2025-007', guestName: 'David Lee', totalAmount: 22000, advanceAmount: 5000, balanceAmount: 17000, pendingAmount: 17000, settlementStatus: 'PENDING', checkInDate: '2025-12-07', checkOutDate: '2025-12-11' },
  { id: '8', reservationNumber: 'RES-2025-008', guestName: 'Amanda White', totalAmount: 35000, advanceAmount: 20000, balanceAmount: 15000, pendingAmount: 15000, settlementStatus: 'PARTIALLY_SETTLED', checkInDate: '2025-12-08', checkOutDate: '2025-12-12' },
];

const statusConfig: Record<SettlementStatus, { label: string; className: string }> = {
  PENDING: { label: 'Pending', className: 'bg-red-100 text-red-700 hover:bg-red-100' },
  SETTLED: { label: 'Settled', className: 'bg-green-100 text-green-700 hover:bg-green-100' },
  PARTIALLY_SETTLED: { label: 'Partially Settled', className: 'bg-orange-100 text-orange-700 hover:bg-orange-100' },
};
